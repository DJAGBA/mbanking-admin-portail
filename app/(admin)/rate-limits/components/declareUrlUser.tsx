...
export function DeclareUrlUserWizard({ onSubmit, onCancel }: any) {
                  ...
                  <div className="border border-gray-200 rounded-xl divide-y bg-gray-50">
                    {paginatedUsers.map((u) => (
                      <div
                        ...
                        className={`flex items-center p-4 cursor-pointer hover:bg-white transition-all ${selectedUsers.some(su => su.id === u.id) ? 'bg-blue-60/60' : ''}`}
                      >
